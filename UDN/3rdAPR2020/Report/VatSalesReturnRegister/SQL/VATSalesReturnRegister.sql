ALTER PROCEDURE "SP_ITN_VatsalesReturnRegister"
AS
BEGIN
SELECT DISTINCT 'Vat Sales Return Register' as "ReportType"
		...
		,IFNULL((SELECT sum(RIN4."TaxSum") FROM RIN4 WHERE T0."DocEntry" = RIN4."DocEntry" AND RIN4."LineNum" = T1."LineNum" AND RIN4."staType" = 1), 0) AS "Tax"
		,IFNULL((SELECT sum(RIN4."BaseSum") FROM RIN4 WHERE T0."DocEntry" = RIN4."DocEntry" AND RIN4."LineNum" = T1."LineNum" AND RIN4."staType" = 1), 0) AS "Value"
