...
BEGIN
	SELECT T0."DocEntry"
		...
		,OW1."Street" AS "CompanyStreet"
		,OW1."StreetNo"  AS "CompanyPoBoX"
		...
		,ISNULL(T21."BeginStr", '') + CAST(ODLN."DocNum" AS nvarchar) + ISNULL(CAST(T21."EndStr" AS CHAR(20)), '') AS "OrderNo"
		...
		,ISNULL(T20."BeginStr", '') + CAST(T0."DocNum" AS nvarchar) + ISNULL(CAST(T20."EndStr" AS CHAR(20)), '') AS "InvNo"
		,T0."DocDate" AS "InvDt"
