CREATE PROCEDURE [dbo].[SP_ITN_HC_SERVICE_CREDIT_MEMO] (@DocKey INT)
--Service_Sales_Return------
AS
BEGIN
	SELECT 
		...
		,concat(ISNULL(T4."BeginStr", '') , CAST(T2."DocNum" AS nvarchar) , CAST(T4."EndStr" AS CHAR(20))) AS "VoucherNo"
