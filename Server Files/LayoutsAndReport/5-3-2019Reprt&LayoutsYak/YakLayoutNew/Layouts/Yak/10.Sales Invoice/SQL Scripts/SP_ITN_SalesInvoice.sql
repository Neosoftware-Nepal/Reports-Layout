...
BEGIN
	SELECT T0."DocEntry"
		...
		,IFNULL(T21."BeginStr", '') || '' || CAST(ODLN."DocNum" AS CHAR(20)) || '' || IFNULL(CAST(T21."EndStr" AS CHAR(20)), '') AS "OrderNo"
		...
		,IFNULL(T20."BeginStr", '') || '' || CAST(T0."DocNum" AS CHAR(20)) || '' || IFNULL(CAST(T20."EndStr" AS CHAR(20)), '') AS "InvNo"
		,T0."DocDate" AS "InvDt"
		...
		,IFNULL(CAST(AD."Building" AS NVARCHAR), '') AS "Building"
